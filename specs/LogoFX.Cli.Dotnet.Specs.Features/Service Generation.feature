...
Scenario Outline: Generate service entity in existing solution
	When I install the template pack 'LogoFX.Templates' from local package
	And I create a folder named 'Generation'
	...
	And The folder 'Generation' contains generated service entity objects for name 'Sample' for solution name 'Test'
